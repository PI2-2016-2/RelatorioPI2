...
% Considerando os produtos gerados nas frentes de trabalho citados nas Seções anteriores o sistema completo integrado que está sendo entregue está de acordo com
...
% repassados na escala em G (9,8 m/s2). Por fim, esses dados passarão pelo processamento para serem persistidos no
