...
\begin{itemize}
  ...
  \item Caso o roteador suporte UPnP, é possível adicionar \textit{port forwarding} para protocolo SSH por meio do seguinte comando: \textit{upnpc -e \textbf{nome da regra} -r 22}.
